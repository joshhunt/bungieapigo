...
type DestinyEnvironmentLocationMapping struct {
	...
	// If this is populated, it is the item that you must possess for this location to be active because
	// of this mapping. (theoretically, a location can have multiple mappings, and some might
	// require an item while others don't)
	...
	// appear because of this mapping. (theoretically, a location can have multiple mappings, and
	// some might require you to be in a specific activity when others don't)
