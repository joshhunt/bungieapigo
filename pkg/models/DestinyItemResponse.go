...
type DestinyItemResponse struct {
	...
	// benefits and abilities, and in Destiny 2 are used almost exclusively for the character's
	// "Builds".
	...
	//  These may need to be combined with Plug Set component data to get a full picture of available
	// plugs on a given socket.
	...
	// Information about objectives on Plugs for a given item. See the component's documentation for
	// more info.
