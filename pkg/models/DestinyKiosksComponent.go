...
// well. If you ever have those, you will find them on the individual character's
// DestinyCharacterKiosksComponent.
// Note that, because this component returns vendorItemIndexes (that is to say, indexes into the
// Kiosk Vendor's itemList property), these results are necessarily content version
// dependent. Make sure that you have the latest version of the content manifest databases before
// using this data.
