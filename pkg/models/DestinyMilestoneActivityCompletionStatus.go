...
// the concept won't apply. For instance, it makes sense to talk about a tier of a raid as being
// Completed or having progress, but it doesn't make sense to talk about a Crucible Playlist in
// those terms.
