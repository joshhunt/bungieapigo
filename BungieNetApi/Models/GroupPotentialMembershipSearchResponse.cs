...
namespace GhostSharper.Models
{
    ...
    public class GroupPotentialMembershipSearchResponse
    {
        ...
        public List<GroupPotentialMembership> Results { get; set; }
        ...
        {
            return this.Equals(input as GroupPotentialMembershipSearchResponse);
        }

        public bool Equals(GroupPotentialMembershipSearchResponse input)
        {
