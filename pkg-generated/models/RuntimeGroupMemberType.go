...
// ClanMemberLevel), but they are all translated to this in the runtime api. These runtime values
// should NEVER be stored anywhere, so the values can be changed as necessary.
