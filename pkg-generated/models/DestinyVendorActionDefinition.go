...
// those actions. I'm not going to bother documenting this yet, as it is unused and unclear if it
// will ever be used... but in case it is ever populated and someone finds it useful, it is defined
// here.
