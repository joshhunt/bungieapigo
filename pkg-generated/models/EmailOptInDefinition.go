...
// Defines a single opt-in category: a wide-scoped permission to send emails for the subject
// related to the opt-in.
type EmailOptInDefinition struct {
    ...
    // The flag value for this opt-in category. For historical reasons, this is defined as a flags
    // enum.
