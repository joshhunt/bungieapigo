...
// Unfortunately, there has been a movement away from providing the richer data in Destiny 2 that
// we used to get in Destiny 1 for Activity Types. For instance, Nightfalls are grouped under the
// same Activity Type as regular Strikes.
