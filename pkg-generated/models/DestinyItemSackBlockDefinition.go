...
// Some items are "sacks" - they can be "opened" to produce other items. This is information
// related to its sack status, mostly UI strings. Engrams are an example of items that are
// considered to be "Sacks".
