...
// opportunity to potentially put more than just item information into the reward data if we're
// able to mine it out in the future. Remember this if you come back and ask "why are quest reward
