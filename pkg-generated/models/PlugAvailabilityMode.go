...
// - UnavailableIfSocketContainsMatchingPlugCategory means that the plug is only available
// if the socket does NOT match the plug category.
// - AvailableIfSocketContainsMatchingPlugCategory means that the plug is only available if
// the socket DOES match the plug category.
