...
type DestinyItemActionBlockDefinition struct {
    ...
    // If performing this action earns you Progression, this is the list of progressions and values
    // granted for those progressions by performing this action.
    ...
    // The identifier hash for the Cooldown associated with this action. We have not pulled this data
    // yet for you to have more data to use for cooldowns.
    ...
    // providing you a single item to pick up from a reward-granting vendor in-game and then
    // immediately consuming itself to provide you multiple items.
