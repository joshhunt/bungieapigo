...
// like to give you a character ID for example, but we don't have it. But we do have these three pieces
// of information. May they help you on your quest to show meaningful data about current
// Fireteams.
// Notably, we don't and can't feasibly return info on characters. If you can, try to use just the
// data below for your UI and purposes. Only hit us with further queries if you absolutely must know
